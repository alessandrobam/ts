...
public class bite extends todoitem {
	...
	public void setWeekday(String value) { weekday.set(value); }
	public StringProperty weekdayProperty() { return weekday; }
	private final IntegerProperty masterid = new SimpleIntegerProperty();
	public int getMasterid() { return masterid.get(); }
	public void setMasterid(int value) { masterid.set(value);}
	public IntegerProperty masteridProperty() { return masterid; }
	...
	public Date getDeadline() { return deadline.get(); }
	public void setDeadline(Date value) { deadline.set(value); }
	public ObjectProperty deadlineProperty() { return deadline; }
	private final ObjectProperty<Date> finished = new SimpleObjectProperty<>();
	public Date getFinished() { return finished.get(); }
	public void setFinished(Date value) { finished.set(value); }
	...
	public int getNext() { return next.get(); }
	public void setNext(int value) { next.set(value); }
	public IntegerProperty nextProperty() { return next; }
	...
	public void setCreated(Date value) { created.set(value); }
	public ObjectProperty createdProperty() { return created; }
	private final ObjectProperty<Date> lastreschedule = new SimpleObjectProperty<>();
	public Date getLastreschedule() { return created.get(); }
	public void setLastreschedule(Date value) { created.set(value); }
	public ObjectProperty lastrescheduleProperty() {return lastreschedule; }
	private final IntegerProperty golden = new SimpleIntegerProperty();
	public int getGolden() { return golden.get(); }
	public void setGolden(int value) { golden.set(value); }
	public IntegerProperty goldenProperty() { return golden; }
	private final IntegerProperty countdown = new SimpleIntegerProperty();
	public int getCountdown() { return countdown.get(); }
	public void setCountdown(int value) { countdown.set(value); }
	public IntegerProperty countdownProperty() { return countdown; }
